...
dependencies {
  ...
  implementation("io.vertx:vertx-web-client:3.9.4-SNAPSHOT")

  implementation("io.vertx:vertx-lang-kotlin:3.9.4-SNAPSHOT")
  implementation("io.vertx:vertx-lang-kotlin-coroutines:3.9.4-SNAPSHOT")
